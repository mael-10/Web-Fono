...
<?php
    ...
    $id_paciente = mysqli_real_escape_string($conexao, $_POST['id']);
                
    $exclui = mysqli_query($conexao, "DELETE FROM paciente WHERE id_paciente = '$id_paciente'");
    echo "Paciente excluído com sucesso do Sistema!";
