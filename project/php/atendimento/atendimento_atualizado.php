...
<head>
  ...
  <title>Atendimento Atualizado</title>
...
$id_atendimento = mysqli_real_escape_string($conexao, $_POST['id_atendimento']);
...
if (!empty($data) && !empty($hora) && !empty($descricao)) {
    $consulta = mysqli_query($conexao, "UPDATE atendimento SET 
        data = '$data',
        hora = '$hora',
        descricao = '$descricao'
