  ...
  <body>
    <main class=" flex justify-center h-screen" id="cd-paciente">
      <div class="container flex items-center flex-col">
        <div class="mb-32">
          <h1 class="text-5xl text-greenF">CADASTRO REALIZADO COM SUCESSO!</h1>
          <div class="mt-20 text-center">
            <button class="text-white bg-buttonGreen hover:bg-buttonHover">Voltar ao Início</button>
          </div>
        </div>
      </div>
      <h1 class="retorno">sucesso</h1>
      <a href="xxx"><button class="bt">voltar ao ínicio </button></a>
    </main>
