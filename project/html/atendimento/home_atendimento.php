...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="../../css/home_atendimento.css " />
    <title>Home atendimento</title>
  ...
  <ul class="h-full list-none space-y-4">
    ...
    <li class="item-menu w-full">
      <a href="../../php/atendimento/retorno_atendimento.php" class="flex items-center">
        <span class="icon">
    ...
    <li class="item-menu w-full">
      <a href="../estoque/cadastrar_estoque.php" class="flex items-center">
        ...
        <span class="txt-link ml-5 overflow-hidden text-white">CadastrarProduto</span>
      </a>
    </li>
    ...
    <main class="content flex-1">
      ...
      <div class="options">
        <a href="../../php/atendimento/atendimento_geral.php" class="options-link">
            <div class="option-content">
                <img class="content-image" src="../../images/atendimentos/2.png" alt="">
                <h1 class="titulo-options">Atendimento Geral</h1>
            </div>
        </a>
    </div>

      <div class="options">
          <a href="../../php/atendimento/retorno_atendimento.php" class="options-link">
              <div class="option-content">
                  <img class="content-image" src="../../images/atendimentos/3.png" alt="">
                  <h1 class="titulo-options">Retorno</h1>
              </div>
          </a>
      </div>
  
      <div class="options">
          <a href="../../php/atendimento/listar_atendimento.php " class="options-link">
              <div class="option-content">
                  <img class="content-image" src="../../images/atendimentos/4.png" alt="">
                  <h1 class="titulo-options">Listar Atendimentos</h1>
              </div>
          </a>
      </div>
