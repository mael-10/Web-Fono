...
<head>
  ...
  <style>
    ...
    .count-box-container {
      ...
      /* Centralizar os quadrados horizontalmente */
      align-items: center;
      /* Centralizar os quadrados verticalmente */
      margin-bottom: 50px;
    ...
    .count-box {
      ...
      /* Os números serão centralizados verticalmente */
      justify-content: center;
      align-items: center;
    }
    ...
    .header {
      ...
      /* Cor de fundo do cabeçalho, ajuste conforme necessário */
      text-align: center;
